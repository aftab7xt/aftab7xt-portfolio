    ...
    <div className="min-h-screen bg-[#0D0D0D] text-white selection:bg-blue-500/30">
      ...
      <main className="max-w-5xl mx-auto px-6 py-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <ProjectCard 
            title="DeenBase"
            description="A comprehensive Islamic utility app featuring the Quran, over 35,000 Hadith, and daily Dhikr tracking. Built for speed and spiritual focus."
            tags={["Kotlin", "Jetpack Compose", "Room DB", "Material 3"]}
          />
          
          <ProjectCard 
            title="Proprietary Media Project"
            description="A high-end cinematic media interface focused on fluid animations, AGSL shaders for progressive blurring, and complex API synchronizations."
      ...
      <footer className="max-w-5xl mx-auto px-6 py-24 border-t border-white/5">
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-8">
          ...
          <a 
            href="https://www.fiverr.com/aftaballi" 
